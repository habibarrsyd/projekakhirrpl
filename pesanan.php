                    ...
                    <div class="rightSide">
                        <div class="partOne">
                            ...
                            <select id="jenis_layanan" name="jenis_layanan">
                                <option value="Layanan A">Paket Hemat Cuci Kilat</option>
                                <option value="Layanan B">Paket Nyaman Grooming Lengkap</option>
...
if (isset($_POST['buat_pesanan'])) {
    // Variabel ini akan terisi jika form disubmit
    $nama = $_POST['nama'];
    $no = $_POST['no_hp'];
